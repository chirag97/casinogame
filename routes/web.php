...
Route::get('challenge1', 'Challege1Controller@index');
Route::get('challenge2', 'Challege2Controller@index');
Route::get('challenge3', 'Challege3Controller@index');
Route::get('challenge4', 'Challege4Controller@index');
