$(document).ready(function () {
    ...
    function printResult() {
        var res;
        if (win[a.pos] === win[b.pos] && win[a.pos] === win[c.pos] && win[b.pos] === win[c.pos]) {
            res = "<h1>Congratulations ! </h1> </br> <p>You Win 500 points!</p> ";
            points += 500;
        } else if (win[a.pos] === win[b.pos] || win[a.pos] === win[c.pos]) {
            res = "<h1>Congratulations ! </h1> </br> <p>You Win 200 points</p>";
            points += 200;
        } else if (win[b.pos] === win[a.pos] || win[b.pos] === win[c.pos]) {
            res = "<h1>Congratulations ! </h1> </br> <p>You Win 200 points</p>";
            points += 200;
        } else if (win[c.pos] === win[a.pos] || win[c.pos] === win[b.pos]) {
            res = "<h1>Congratulations ! </h1> </br><p>You Win 200 points</p>";
            points += 200;
        } else {
            res = "<h1>Ooops One more try ! </h1> </br><p>You Lose</p>";
            points += 0;
        }
        // $('#result').html(res);
        swal(res);
    ...
    $('#control').click(function () {
        ...
        if (this.innerHTML == "Spin Now") {
            if (attempts < 3) {
                ...
                swal('you are out of attempts ! please wait for 30 minutes');
            }
